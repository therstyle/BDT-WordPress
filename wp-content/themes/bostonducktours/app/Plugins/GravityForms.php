...
class GravityForms {
	...
	private static function add_entry( int $form_id, array $fields ) {
		// This is the previous way I tried doing it. It works (saves the entry),
		// but doesn't validate the inputs.

		// $params = [
		// 	'form_id' => $form_id
		// ];

		// // Why we cannot use array_merge:
		// // IDs of the fields are numeric, and if one of the arrays in array_merge
		// // has numeric keys, they are renumbered from 0.
		// foreach ( $fields as $field_id => $field_value ) {
		// 	$params[ $field_id ] = $field_value;
		// }

		// return \GFAPI::add_entry( $params );
